...
| **Near Duplicate** | Edit distance within threshold — at least 2 edits, scaling to ~8% of length (catches typos like "Micheal"/"Michael"). Skipped above 300 names, with a notice | 5 |
